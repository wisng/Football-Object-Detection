...
class Tracker:
    ...
    def draw_annotations(self, video_frames, tracks, team_ball_control):
        ...
        for frame_num, frame in enumerate(video_frames):
            ...
            for _, ball in ball_dict.items():
                frame = self.draw_triangle(frame, ball["bbox"], color=(255,255,0))
    ...
    def draw_ellipse(self, frame, bbox, color, track_id=None):
        ...
        cv.ellipse(frame, center=(x_center, y2), axes=(width, int(width*0.35)), angle=0, startAngle=-45, endAngle=235, color=color, thickness=2, lineType=cv.LINE_4)       
